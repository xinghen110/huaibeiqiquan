 ...
 *  功能说明: 客户端极光推送
 * 
 *  <br/>创建说明: 2017-8-22 下午02:31:20 chenqm  创建文件<br/>
 * 
 *  修改历史:<br/>
 *
 */
public class JpushClientUtil {
    ...
    public static void main(String[] args) {
    	JpushClientUtil.sendToRegistrationId("141fe1da9e917b19187", "您的订单被取消了", "您的订单被取消了", "您好,您的订单被取消了", 1, "TC2017082215061970000010");
	}
