...
public class GetGuPiao {
    ...
    public static List getZSData(String code) {
        String host = "http://47.52.21.70:6080/getZSData="+code;
        ...
        try {
            ...
            HttpResponse response = httpClient.execute(new HttpGet(host));
            //获取response的body
            String body = EntityUtils.toString(response.getEntity());
            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                ...
                map.put("business_amount",(String)obj.get("business_amount"));
                map.put("last_px",(String)obj.get("last_px"));
                map.put("avg_px",(String)obj.get("avg_px"));
                map.put("min_time",(String)obj.get("min_time"));
                result.add(map);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void main(String[] args) {
        ...
        List zsData = GetGuPiao.getZSData("000002.SZ");
