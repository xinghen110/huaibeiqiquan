...
public class ClientContext {
	...
	private void initFromPropertiesFile() {
		...
		try {
			InputStream inputStream = ClientContext.class.getClassLoader().getResourceAsStream("huanxinconfig.properties");
			p.load(inputStream);
		} catch (IOException e) {
			log.error(MessageTemplate.print(MessageTemplate.FILE_ACCESS_MSG, new String[]{"huanxinconfig.properties"}));  
