...
public class SDKConfig {
    ...
    private static Logger log = LoggerFactory.getLogger(SDKConfig.class);
    ...
    /** version */
    private final String SDK_VERSION = "acpsdk.version";
    /** 后台通知地址  */
    private final String SDK_BACKURL = "acpsdk.backUrl";
    /** 前台通知地址  */
    private final String SDK_FRONTURL = "acpsdk.frontUrl";
    /** 操作对象. */
    ...
    private void loadPropertiesFromPath(String rootPath) {
        if (StringUtils.isNotBlank(rootPath)) {
            log.warn("从路径读取配置文件: " + rootPath+File.separator+FILE_NAME);
    ...
    public void loadPropertiesFromSrc() {
        InputStream in = null;
        try {
            log.warn("从classpath: " +SDKConfig.class.getClassLoader().getResource("").getPath()+" 获取属性文件"+FILE_NAME);
    ...
    private void loadProperties(Properties pro) {
        ...
        value = pro.getProperty("acpsdk.mer.id");
        if (!SDKUtil.isEmpty(value)) {
