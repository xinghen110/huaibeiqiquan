	...
	<body>
			...
			<div data-role = "content">
				...
				<c:if test="${empty user.auditShopStatus || user.auditShopStatus == 3}">
					<form id="forms"><!-- 商家  -->
						<div>
							<h4>店铺名称：</h4>
							<input type="text" placeholder="请输入店铺名称" id="zsxm" value="${shopInfo.shopName}"/>
						</div>
						<div>
							<h4>联系方式：</h4>
							<input type="number" placeholder="请输入店铺联系方式" id="sjhm" value="${shopInfo.linkTel}"/>
						</div>
						<div>
							<h4>店铺地址：</h4>
							<input type="text" id="businessAddress" placeholder="请输入店铺详细地址" value="${shopInfo.address}" />
						</div>
		...
		<script type="text/javascript">
            ...
            $("#submit").click(function(){
                ...
                if(nickName == "" || userPhone == "" || $('#businessAddress').val().trim() == "" || typeNum == null ){
                    alert("数据填写不完整！");
                    return false;
                }
