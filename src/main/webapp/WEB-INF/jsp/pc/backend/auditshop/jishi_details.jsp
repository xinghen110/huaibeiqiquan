    ...
    <div class="investment_con" style="border:none;width:830px;height:450px;overflow: auto;">
        <div class="investment_con_list" style="display:block;">
            ...
            <table class="new_tab">
                ...
                <tr>
                    <td width="112" align="right" class="cue">技师姓名：</td>
                    <td  width="200">${shopInfo.shopName}</td>

                    <td  width="116" align="right" class="cue">技师编号：</td>
                    <td  width="200">${shopInfo.shopNum}</td>
                </tr>

                <tr>
                    <td width="112" align="right" class="cue">技师性别：</td>
                    <td  width="200"><ry:show parentCode="USERSEX" itemCode="${shopInfo.userSex}"></ry:show></td>

                    <td  width="116" align="right" class="cue">出生年月：</td>
                    <td  width="200">${shopInfo.userBirth}</td>
                </tr>

                <tr>
                    <td width="112" align="right" class="cue">技师手机号：</td>
                    <td  width="200">${shopInfo.linkTel}</td>

                    <td  width="116" align="right" class="cue">技师服务类别：</td>
                    <td  width="200">${shopInfo.flag1}</td>
                </tr>

                <tr>
                    <td width="112" align="right" class="cue">技师常驻地址：</td>
                    <td  colspan="3">
                ...
                <tr>
                    <td width="112" align="right" class="cue">技师审核材料：</td>
                    <td colspan="3"></td>
                </tr>
                <tr>
