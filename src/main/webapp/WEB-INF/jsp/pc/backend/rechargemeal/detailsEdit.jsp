...
<div class="investment_f" style="width:850px;height:492px;">
  <div class="investment_con" style="border:none;width:830px;height:460px;overflow: auto;">
    <div class="investment_con_list" style="display:block;">
	    ...
	    <table class="new_tab">
	         <tr>
			     <td colspan="4"  class="cue"><h2>充值套餐详情</h2></td>
		     </tr>
		     <tr>
			     <td width="112" align="right" class="cue">用户名称：</td>
			     <td colspan="3" width="200">${user.nickName }</td> 
			 </tr>
		     <tr>
			    
			     <td  width="100" align="right" class="cue">充值金额：</td>
			     <td  width="200">${bean.amount }</td>
		     </tr>
				<tr>
					<td width="100" align="right" class="cue">积分</td>
					<td width="200">${bean.score }</td>
				</tr>
		     <tr>
			     <td align="right" class="cue">评论时间：</td>
