...
<ul class="toolBar">
	...
	<li><a class="add" onclick="add('shoptype/toEdit?parentNum=${bean.parentNum}','添加同城分类信息',900,600,'main_')" ><span>添加</span></a></li>
	...
	<thead>
		<tr>
		   <!-- <th width="center" align="center"><input type="checkbox" group="ids" class="checkboxCtrl"></th> -->
			...
			<th width="center" align="center">美食外卖名称</th>
	...
	<tbody>
		<c:forEach var="item" items="${pageList.result}" varStatus="row">
			<tr>
				...
				<td >${item.sortNum}</td>
				<td>
					<a title="修改黄页分类信息"   onclick="add('shoptype/toEdit?shopTypeNum=${item.shopTypeNum}&parentNum=${bean.parentNum}','修改黄页分类信息',900,600,'main_')"  rel="users_saveedit" class="btnEdit">修改</a>				
