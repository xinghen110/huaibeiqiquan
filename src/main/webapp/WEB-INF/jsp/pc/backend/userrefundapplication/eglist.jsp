...
<table class="table" width="100%" layoutH="133">
	<thead>
		<tr>
			...
			-->
			<th width="center" align="center">换货时间</th>
	...
	<tbody>
		<c:forEach var="item" items="${pageList.result}" varStatus="row">
			<tr>
				...
				<td><a href="javascript:void(0)" onclick="openNav('userrefundapplication/toDetailsEdit?userRefundApplicationNum=${item.userRefundApplicationNum }&refundType=${refundType }','退货申请详情','main_index3')"><span style="color: blue;">${item.orderNum }</span></a></td>
				<td>${item.userNum }</td>
