...
<form id="pagerForm" method="post" action="userrefundapplication/list?refundType=${bean.refundType}">
...
<ul class="searchContent">
	...
	<li>
		...
		<option value="">全部</option>
			<c:forEach items="${refundStatus}" var="item">
...
<table class="table" width="100%" layoutH="133">
	<thead>
		<tr>
			...
			<th width="center" align="center">商户编号</th>
			...
			<th width="center" align="center">退款时间</th>
	...
	<tbody>
		<c:forEach var="item" items="${pageList.result}" varStatus="row">
			<tr>
				...
				<td><a href="javascript:void(0)" onclick="openNav('userrefundapplication/toDetailsEdit?userRefundApplicationNum=${item.userRefundApplicationNum }&refundType=${refundType }','退款申请详情','main_index3')"><span style="color: blue;">${item.orderNum }</span></a></td>
				<td>${item.orderTrain.outTrainOrder }</td>
				<td>${item.userNum }</td>
