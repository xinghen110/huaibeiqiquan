...
<form id="pagerForm" method="post" targetType="dialog" action="adverinfo/getFindBack">
...
<div class="pageHeader">
	...
	<form onsubmit="return dwzSearch(this, 'dialog');" action="adverinfo/getFindBack" method="post" >
	<div class="searchBar">
