...
<form id="pagerForm" method="post" action="admin/video/list">
...
<div class="pageHeader">
    <form onsubmit="return navTabSearch(this);" action="admin/video/list" method="post">
        <div class="searchBar">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" onclick="add('admin/video/add','添加视频信息',900,500,'main_')"><span>添加视频信息</span></a></li>
...
<table class="table" width="100%" layoutH="132">
    ...
    <tr>
        ...
        <th width="center" align="center">配图URL链接</th>
        <th width="center" align="center">视频URL链接</th>
    ...
    <c:forEach var="item" items="${pageList.result}" varStatus="row">
        <tr>
            ...
            <td>${item.linkUrl}</td>
            <td>
                <a onclick="add('admin/video/update?articleId=${item.articleId}','修改视频信息',900,600,'main_')" rel="users_saveedit" class="btnEdit">操作</a></td>
