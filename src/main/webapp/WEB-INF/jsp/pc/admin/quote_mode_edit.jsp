...
<form method="post" action="market/quotemode/saveOrUpdate" id="forms" class="pageForm required-validate" onsubmit="return iframeCallback(this,dialogAjaxDone);" enctype="multipart/form-data">
<div class="pageFormContent nowrap" layoutH="63">
		...
		<input type="hidden" value="${bean.status }" name="status">
