		...
		<tbody>
			...
			<tr target="sid_user" rel="1">
				...
				<td>
					...
					<a href="javascript:void(0)" onclick="makeTop(2,'${item.userNum}','user_status','citydiscount/updateQuery','t_user','user_num')"><span style="color: green">启用</span></a>
					</c:if>
					<c:if test="${item.userStatus==2}">
					<a href="javascript:void(0)" onclick="makeTop(1,'${item.userNum}','user_status','citydiscount/updateQuery','t_user','user_num')"><span style="color: red">禁用</span></a>
					</c:if>
				</td>
				<td>
