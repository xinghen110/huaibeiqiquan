                ...
                <li>
                    <div class="buttonActive">
                        <div class="buttonContent">
                            <button id="check1" type="button" onclick="formSubmit(1);">审核通过</button>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="buttonActive">
                        <div class="buttonContent">
                            <button id="check2" type="button" onclick="formSubmit(2);">审核不通过</button>
                        </div>
                    </div>
                </li>
                <li><div class="button"><div class="buttonContent"><button id="check3" type="button" class="close">取消</button></div></div></li>
            </ul>
        </div>
        <!-- 隐藏的值 -->
        <input type="hidden" name="id" value="${userInfoCheck.id}"/>
        <input type="hidden" id="result" name="checkResult" value="">
    </form>
</div>
<script>
    var isVal=true;
    function formSubmit(str){
        $("input#result").val(str);
        if(isVal==false){
            $('#fali_show').show();
            return false;
        }else{
