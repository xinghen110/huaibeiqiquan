<%@ page contentType="text/html;charset=UTF-8" language="java" %>
	<select name="province" title="省" class="mustFill" id="provinceEdit" onchange="queryCitiesEdit(this.value,'','')"  style="width: 90px">
		<option value="">请选择</option>
     		</select> 
	<select name="city" title="市" class="mustFill" id="cityEdit" onchange="queryAreaEdit(this.value,'')"   style="width: 90px">
	<option></option>
	</select>
	<select name="areas" title="区" id="areaEdit"   style="width: 90px">
		<option></option>
	</select>
<script>
