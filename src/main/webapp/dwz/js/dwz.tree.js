 ...
 (function($){
 	$.extend($.fn, {
			...
			return this.each(function(){
				...
				setTimeout(function(){
						...
						if(checkFn && $.isFunction(checkFn)) {
							$("div.ckbox", $this).each(function(){
								...
								ckbox.click(function(){
									...
									$("div.ckbox.checked", $this).find("input[type='checkbox']").attr("checked",true);
									$("div.ckbox.indeterminate", $this).find("input[type='checkbox']").attr("checked",true);
					...
					$("a", $this).click(function(event){
						...
						//$("div.accordionContent div." + op.selected).removeClass(op.selected);
		...
		_check:function(op) {
			...
			var tname = $input.attr("tname"), tvalue = $input.attr("tvalue"),tchecked=$input.attr("checked");
			var attrs = "text='"+$input.text()+"' ";
			if (tname) attrs += "name='"+tname+"' ";
			if (tvalue) attrs += "value='"+tvalue+"' ";
			if (tchecked) attrs += "checked='"+tchecked+"' ";
		...
		_checkParent:function(){
			...
			parent._checkParent();
			$("div.ckbox.checked").find("input[type='checkbox']").attr("checked",true);
			$("div.ckbox.indeterminate").find("input[type='checkbox']").attr("checked",true);
		}
	});
})(jQuery);