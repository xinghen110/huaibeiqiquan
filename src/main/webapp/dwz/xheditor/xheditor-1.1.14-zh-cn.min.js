(function (e, $) {
    ...
    if (h) {
        ...
        } catch (qb) {}(I = e.fn.jquery) && I.match(/^1\.[67]/) &&
...
//            }
            ...
            full: "Cut,Copy,Paste,Pastetext,Undo,Redo,|,Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,SelectAll,Removeformat,|,Align,List,Outdent,Indent,|,Link,Unlink,Anchor,Img,Flash,Media,Hr,Emot,Table,|,Source,Preview,Print,Fullscreen"
        };
    ...
    var lb = {
        ...
        ra = function (z, o) {
            ...
            function Ua(a) {
                ...
                setTimeout(function () {
                    ...
                    if (b = b.replace(/^[\s\uFEFF]+|[\s\uFEFF]+$/g, ""))
                        if (a) d.pasteText(b);
                        else if (b = d.cleanHTML(b), b = d.cleanWord(b), b = d.formatXHTML(b), !g.onPaste || g.onPaste && !1 !== (b = g.onPaste(b))) b =
                        Va(b), d.pasteHTML(b);
                    Ja = !1
                }, 0)
            }
            ...
            this.init = function () {
                ...
                if (a = g.loadCSS)
                    if (M(a, "array"))
                        for (var j in a) P += '<link rel="stylesheet" href="' + a[j] + '"/>';
                    ...
                    if (a && (b = a.files) && 0 < b.length) {
                        ...
                        k = function (a) {
                            ...
                            for (c = 0; c < a.length; c++)
                                if (b = a[c].name.replace(/.+\./, ""), b = j.match(RegExp("(\\w+):[^:]*," + b + "(?:,|$)",
                                    "i")))
                                    if (d) {
                                        if (d !== b[1]) return 2
                                    } else d = b[1];
                ...
                if ("write" === b) {
                    ...
                    if (!R) var c = function (a, b, c, d, e, f) {
                        ...
                        return "" !== b ? (d && (b += ' style="' + d + '"'), "<font" + (c ? c : "") + b + (e ? e : "") + ">" + f + "</font>") : a
                            ...
                            c),
                    a = a.replace(/<(span)(\s+[^>]*?)?\s+style\s*=\s*"((?:[^"]*?;)?\s*(?:font-family|font-size|color)\s*:[^"]*)"( [^>]*)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?)<\/\1>/ig, c), a = a.replace(/<(span)(\s+[^>]*?)?\s+style\s*=\s*"((?:[^"]*?;)?\s*(?:font-family|font-size|color)\s*:[^"]*)"( [^>]*)?>(((?!<\1(\s+[^>]*?)?>)[\s\S])*?)<\/\1>/ig, c);
            ...
            this.formatXHTML = function (a, b) {
                ...
                for (var u, C, q = 0, t, z, v = -1, A = "body", B = !1; u = n.exec(a);) {
                    ...
                    q = n.lastIndex;
                    if (C = u[1])
                        if (C = e(C), t && C === t && (p(z.join("")), z = t = null), !t) {
                            g(C);
                            continue
                        }
            ...
            this.toggleSource = function (a) {
                if (x !== a) {
                    ...
                    if (x) f = d.getSource(), c.html("").removeAttr("scroll").attr("class",
                        "editMode" + Q), h ? b.contentEditable = "true" : l.designMode = "On", qa && (d._exec("inserthtml", "-"), e("#" + za).show().focus().hide()), g = "\u6e90\u4ee3\u7801";
                    else {
            ...
            this.showEmot = function (a) {
                var b = e('<div class="xheEmot"></div>'),
                    ...
                    c = c.list;
                if (s)
                    for (c = 1; c <= s; c++) g++, m.push("<a href=\"javascript:void('" + c + '\')" style="background-image:url(' + f + c + '.gif);" emot="' + a + "," + c + '" xhev="" title="' + c + '" role="option">&nbsp;</a>'), 0 === g % w && m.push("<br />");
